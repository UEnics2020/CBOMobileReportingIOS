...
public class RptModel {
    ...
    private var dairyCount,PolutaryCount: String!
    ...
    func  getDairyCount() -> String {
        return dairyCount;
    }
    
    func  setDairyCount( dairyCount : String) {
        self.dairyCount = dairyCount;
    }
    
    func  getPolutaryCount() -> String{
        return PolutaryCount;
    }
    
    func  setPolutaryCount( polutaryCount : String) {
        self.PolutaryCount = polutaryCount;
    }
}

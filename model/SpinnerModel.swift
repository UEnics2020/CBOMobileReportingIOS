...
//    public init(name : String,id : String,PLANE_TYPE : String){
//        self.name=name;
//        self.id=id;
//        self.PANE_TYPE = PLANE_TYPE;
//    }
    ...
    public init(name : String,id : String, last_visited : String, CLASS : String, POTENCY_AMT : String, ITEM_NAME : String
        , ITEM_POB : String, ITEM_SALE : String, AREA : String, PANE_TYPE : String,  DR_LAT_LONG : String, FREQ : String,  NO_VISITED : String, DR_LAT_LONG2 : String,  DR_LAT_LONG3 : String, COLORYN : String, CALLYN : String, CRM_COUNT : String, DRCAPM_GROUP : String,APP_PENDING_YN : String){
        ...
        self.APP_PENDING_YN = APP_PENDING_YN;
    }
    ...
    func getCALLYN() -> String
{
    ...
    func  getAPP_PENDING_YN() -> String {
        return APP_PENDING_YN;
    }
    
    func  setAPP_PENDING_YN( APP_PENDING_YN : String) {
        self.APP_PENDING_YN = APP_PENDING_YN;
    }

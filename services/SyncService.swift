...
class SyncService {
    ...
    var sDCRDR_DR_ID = "",  sDCRDR_WW1 = "",  sDCRDR_WW2 = "",  sDCRDR_WW3 = "",  sDCRDR_LOC = "",  sDCRDR_IN_TIME = "",  sDCRDR_BATTERY_PERCENT = "",  sDCRDR_REMARK = "",  sDCRDR_KM = "",  sDCRDR_SRNO = "", sDCRDR_FILE = "", sDCRDR_CALLTYPE  = "", sDR_REF_LAT_LONG = ""
    
    var sDCRCHEM_CHEM_ID = "",  sDCRCHEM_POB_QTY = "",  sDCRCHEM_POB_AMT = "",  sDCRCHEM_ITEM_ID_ARR = "",  sDCRCHEM_QTY_ARR = "",  sDCRCHEM_LOC = "",  sDCRCHEM_IN_TIME = "",  sDCRCHEM_SQTY_ARR = "",  sDCRCHEM_ITEM_ID_GIFT_ARR = "",  sDCRCHEM_QTY_GIFT_ARR = "",  sDCRCHEM_BATTERY_PERCENT = "",  sDCRCHEM_KM = "",  sDCRCHEM_SRNO = "", sDCRCHEM_REMARK = "", sDCRCHEM_FILE  = "",sCHEM_REF_LAT_LONG = "",sCHEM_STATUS = "",sCOMPETITOR_REMARK = ""
    
    var sDCRSTK_STK_ID = "",  sDCRSTK_POB_QTY = "",  sDCRSTK_POB_AMT = "",  sDCRSTK_ITEM_ID_ARR = "",  sDCRSTK_QTY_ARR = "",  sDCRSTK_LOC = "",  sDCRSTK_IN_TIME = "",  sDCRSTK_SQTY_ARR = "",  sDCRSTK_ITEM_ID_GIFT_ARR = "",  sDCRSTK_QTY_GIFT_ARR = "",  sDCRSTK_BATTERY_PERCENT = "",  sDCRSTK_KM = "",  sDCRSTK_SRNO = "", sDCRSTK_REMARK = "", sDCRSTK_FILE  = "",sSTK_REF_LAT_LONG = ""
    
    var sDCRRC_IN_TIME = "",  sDCRRC_LOC = "",  sDCRRC_DR_ID = "",  sDCRRC_KM = "",  sDCRRC_SRNO = "", sDCRRC_BATTERY_PERCENT = "", sDCRRC_REMARK = "", sDCRRC_FILE  = "",sRC_REF_LAT_LONG = ""
    ...
    var sDAIRY_ID = "", sSTRDAIRY_CPID = "",sDCRDAIRY_LOC = "",sDCRDAIRY_IN_TIME = "",sDCRDAIRY_BATTERY_PERCENT = "",sDCRDAIRY_REMARK = "",sDCRDAIRY_KM = "",sDCRDAIRY_SRNO = "",sDAIRY_REF_LAT_LONG = ""
    ...
    var DCRSTK_RATE = "", DCRDR_RATE = "", DCRCHEM_RATE = "";
    ...
    func  DCR_sync_all(responseCode : Int, ReplyYN : String? = "N"){
        ...
        do {
            ...
            if (IsGPRS_ON && (!dcr_Commit_rx.isEmpty || dcr_Commit_rx.count > 0 ||
                ...
                request["sSTKITEM_RATE"] = DCRSTK_RATE
                request["sDRITEM_RATE"] = DCRDR_RATE
                request["sCHEMITEM_RATE"] = DCRCHEM_RATE
               ...
               request["sCOMPETITOR_REMARK"] = sCOMPETITOR_REMARK
                ...
                CboServices().customMethodForAllServices(params: request , methodName: "DCR_SYNC_MOBILE_ALL_6", tables: tables, response_code: responseCode, vc: context)

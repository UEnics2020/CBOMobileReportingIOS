        ...
        if (!dataFromAPI.isEmpty) {
            ...
            do{
                ...
                for  i in  0  ..< jsonArray23.count {
                    ...
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc , key : "fmcg_value", value: try c.getString(key: "FMCG") )
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc , key:  "root_needed", value:  try c.getString(key: "ROUTE") )
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key : "gps_needed", value:  try c.getString(key: "GPRSYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key :"version", value:  try c.getString(key: "VER") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc  ,key : "doryn", value : try c.getString(key: "DORYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc , key : "dosyn", value:  try c.getString(key: "DOSYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key:  "internet",value:  try c.getString(key: "INTERNET_RQD") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "live_km",value:  try c.getString(key: "LIVE_KM") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc , key :"leave_yn", value:  try c.getString(key: "LEAVEYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "WEBSERVICE_URL",value:  try c.getString(key: "WEBSERVICE_URL") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "WEBSERVICE_URL_ALTERNATE",value:  try c.getString(key: "WEBSERVICE_URL_ALTERNATE") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "FLASHYN",value: try  c.getString(key: "FLASHYN") )
                    //customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,"FLASHYN", c.getString("FLASHYN"as! String )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_REMARK_NA",value:  try c.getString(key: "DCR_REMARK_NA") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_DR_REMARKYN", value:  try c.getString(key: "DCR_DR_REMARKYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "ROUTEDIVERTYN", value:  try c.getString(key: "ROUTEDIVERTYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_ADDAREANA", value: try c.getString(key: "DCR_ADDAREANA") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "VISUALAIDPDFYN", value: try c.getString(key: "VISUALAIDPDFYN") )
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SAMPLE_POB_MANDATORY", value: try c.getString(key: "SAMPLE_POB_MANDATORY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "REMARK_WW_MANDATORY", value: try c.getString(key: "REMARK_WW_MANDATORY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SAMPLE_POB_INPUT_MANDATORY", value : try c.getString(key: "SAMPLE_POB_INPUT_MANDATORY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "MISSED_CALL_OPTION", value : try c.getString(key: "MISSED_CALL_OPTION") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "APPRAISALMANDATORY", value : try c.getString(key: "APPRAISALMANDATORY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "USER_NAME", value : try c.getString(key: "USER_NAME") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "PASSWORD", value : try c.getString(key: "PASSWORD") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "VISUALAID_DRSELITEMYN",value : try c.getString(key: "VISUALAID_DRSELITEMYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DOB_REMINDER_HOUR", value : try c.getString(key: "DOB_REMINDER_HOUR") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SYNCDRITEMYN", value : try c.getString(key: "SYNCDRITEMYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "GEO_FANCING_KM", value : try c.getString(key: "GEO_FANCING_KM") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "FIRST_CALL_LOCK_TIME", value :  try c.getString(key: "FIRST_CALL_LOCK_TIME") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "mark", value : try c.getString(key: "FLASH_MESSAGE") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "NOC_HEAD", value : try c.getString(key: "NOC_HEAD") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "USER_PIC",value : try c.getString(key: "USER_PIC") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_LETREMARK_LENGTH", value : try c.getString(key: "DCR_LETREMARK_LENGTH") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SAMPLEMAXQTY", value : try c.getString(key: "SAMPLEMAXQTY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "POBMAXQTY", value : try c.getString(key: "POBMAXQTY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "ASKUPDATEYN", value : try c.getString(key: "ASKUPDATEYN") )
                    ...
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "CALLWAITINGTIME", value : try c.getString(key: "CALLWAITINGTIME") )
                    ...
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "RE_REG_KM", value : try c.getString(key: "RE_REG_KM") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "ERROR_EMAIL", value : try c.getString(key: "ERROR_EMAIL") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DIVERT_REMARKYN", value : try c.getString(key: "DIVERT_REMARKYN") )
                    
                    // MARK:- Diary
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "NLC_PIC_YN", value : try c.getString(key: "NLC_PIC_YN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "RX_MAX_QTY", value : try c.getString(key: "RX_MAX_QTY") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SHOW_ADD_REGYN", value : try c.getString(key: "SHOW_ADD_REGYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "EXP_ATCH_YN", value : try c.getString(key: "EXP_ATCH_YN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "FARMERADDFIELDYN", value : try c.getString(key: "FARMERADDFIELDYN") )
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "NO_DR_CALL_REQ", value : try c.getString(key: "NO_DR_CALL_REQ") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DR_RX_ENTRY_YN", value : try c.getString(key: "DR_RX_ENTRY_YN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "RETAILERCHAINYN", value : try c.getString(key: "RETAILERCHAINYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_SUBMIT_TIME", value : try c.getString(key: "DCR_SUBMIT_TIME") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_SUBMIT_SPEACH", value : try c.getString(key: "DCR_SUBMIT_SPEACH") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "ALLOWED_APP", value : try c.getString(key: "ALLOWED_APP") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCRGIFT_QTY_VALIDATE", value : try c.getString(key: "DCRGIFT_QTY_VALIDATE") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SAMPLE_BTN_CAPTION", value : try c.getString(key: "SAMPLE_BTN_CAPTION") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "GIFT_BTN_CAPTION", value : try c.getString(key: "GIFT_BTN_CAPTION") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DIVERTWWYN", value : try c.getString(key: "DIVERTWWYN") )
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "PIN_ALLOWED_MSG", value : try c.getString(key: "PIN_ALLOWED_MSG") )
                    
                    
                    /// implemantation is pending
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "CMC3_GALLERY_REQ", value: try c.getString(key: "CMC3_GALLERY_REQ"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DR_COLOR", value: try c.getString(key: "DR_COLOR"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCRPPNA", value: try c.getString(key: "DCRPPNA"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DR_SALE_URL", value: try c.getString(key: "DR_SALE_URL"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "REG_ADDRESS_KM", value: try c.getString(key: "REG_ADDRESS_KM"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DR_DIVISION_FILTER_YN", value: try c.getString(key: "DR_DIVISION_FILTER_YN"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DR_RXGEN_VALIDATE", value: try c.getString(key: "DR_RXGEN_VALIDATE"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "FIREBASE_SYNCYN", value: try c.getString(key: "FIREBASE_SYNCYN"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCRDRADDAREA_APP_MSG", value: try c.getString(key: "DCRDRADDAREA_APP_MSG"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DRGIFTMANDATORY", value: try c.getString(key: "DRGIFTMANDATORY"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_MULTIPLE_ROUTEYN", value: try c.getString(key: "DCR_MULTIPLE_ROUTEYN"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_LEAD_ENTRY_YN", value: try c.getString(key: "DCR_LEAD_ENTRY_YN"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_CALL_STATUS_YN", value: try c.getString(key: "DCR_CALL_STATUS_YN"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "FY_FDATE", value: try c.getString(key: "FY_FDATE"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "FY_TDATE", value: try c.getString(key: "FY_TDATE"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "ORD_DISC_TYPE", value: try c.getString(key: "ORD_DISC_TYPE"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "SALE_ORDER_REMARKYN", value: try c.getString(key: "SALE_ORDER_REMARKYN"));
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "ORD_DISC_EDITCOLS", value: try c.getString(key: "ORD_DISC_EDITCOLS"));
                    
                     customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DRCALLPRODUCT_MANDATORYYN", value: try c.getString(key: "DRCALLPRODUCT_MANDATORYYN"));
                     customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "CALLNA_AFTEREXPSUBMIT", value: try c.getString(key: "CALLNA_AFTEREXPSUBMIT"));
                    
                     customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCRSAMPLE_AFTERVISUALAIDYN", value: try c.getString(key: "DCRSAMPLE_AFTERVISUALAIDYN"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCR_DR_REMARKYN", value: try c.getString(key: "DCR_DR_REMARKYN"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "CHEMCALL_RCPABUTTONYN", value: try c.getString(key: "CHEMCALL_RCPABUTTONYN"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "EXPTA_MGRMANUALYN", value: try c.getString(key: "EXPTA_MGRMANUALYN"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE(vc: vc ,key: "MANUAL_TA",value: "0.0");
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "VISUALAID_VERSION", value: try c.getString(key: "VISUALAID_VERSION"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "API_TOKEN", value: try c.getString(key: "API_TOKEN"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "API_URL_MOBILE", value: try c.getString(key: "API_URL_MOBILE"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "DCRSUMMARYONFINALSUBMIT", value: try c.getString(key: "DCRSUMMARYONFINALSUBMIT"));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE( vc : vc ,key: "GEO_FANCING_KM_FOR", value: try c.getString(key: "GEO_FANCING_KM_FOR"));
                ...
                customVariablesAndMethod.getAlert(vc: vc, title: "Complete  !!!!",
                                                  msg: "Upload Download Sucessfully Completed.....", completion :  {_ in
    ...
    func parser_FCM(dataFromAPI : [String : NSArray]) {
        do {
            if(!dataFromAPI.isEmpty){
                ...
                let MyDaType = try one.getString(key: "DCRID") ;
                threadMsg(msg: "OK");
            }
        }catch {
    ...
    func parser_DCRCOMMIT_DOWNLOADALL(dataFromAPI : [String : NSArray]) {
        ...
        do {
            if(!dataFromAPI.isEmpty){
                ...
                cbohelp.delete_phdoctor(DoNotDeleteCalledDrs: customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: vc,key: "DCR_MULTIPLE_ROUTEYN", defaultValue: "N").uppercased() == ("Y"));

                for i in 0 ..< table1.count{
                    let c = table1[i] as! [String : AnyObject]
                    
                    try cbohelp.insert_phdoctor(dr_id: Int(c.getString(key: "DR_ID") )!, dr_name: c.getString(key: "DR_NAME") , dr_code: "", area: "",spl_id: Int(c.getString(key: "SPL_ID") )!,LAST_VISIT_DATE: c.getString(key: "LASTCALL") as! String,
                                                CLASS: c.getString(key: "CLASS") , PANE_TYPE: c.getString(key: "PANE_TYPE") ,POTENCY_AMT: c.getString(key: "POTENCY_AMT") as! String,
                ...
                for i in 0 ..< Tables4.count{
                    ...
                    try cbohelp.insertDoctorData(dr_id: Int(c.getString(key: "DR_ID") )!, item_id: Int(c.getString(key: "ITEM_ID") as! String)!,item_name: c.getString(key: "ITEM_NAME") as! String)
...
//                }
                ...
                for i in 0 ..< Tables8.count{
                    ...
                    try cbohelp.insert_phdairy_person(DAIRY_ID: Int(c.getString(key: "DAIRY_ID") )! , PERSON_ID: Int(c.getString(key: "PERSON_ID") as! String)!, PERSON_NAME: c.getString(key: "PERSON_NAME") as! String)
...
//                        cbohelp.insert_phdairy_person( jasonObj2.getInt("DAIRY_ID"),jasonObj2.getInt("PERSON_ID"),jasonObj2.getString("PERSON_NAME"));
               ...
               for i in 0 ..< Tables9.count{
                    ...
                    try cbohelp.insert_phdairy_reason(PA_ID: Int(c.getString(key: "PA_ID"))! , PA_NAME: c.getString(key: "PA_NAME") as! String)
                }
                ...
                for i in 0 ..< table10.count{
                    ...
                    try cbohelp.insert_Item_Stock( ITEM_ID: c.getString(key: "ITEM_ID"), STOCK_QTY: Int(c.getString(key: "STOCK_QTY") as! String)! );
                }

...
class SpoRptGrid : CustomUIViewController {
    ...
    func GetSpoCNFGrid(){
        ...
        params["sCurrencyType"]  = VCIntent["CurrencyType"]
        
        var tables =  [Int]()
        tables.append(0)
        progressHUD.show(text: "Please Wait.. ")
        
        CboServices().customMethodForAllServices(params: params, methodName: "SpoCNFGrid_1", tables: tables, response_code: MESSAGE_INTERNET, vc : self,multiTableResponse: false)

...
class DOB_DOA: CustomUIViewController {
    ...
    override func viewDidLoad() {
        ...
        from_DatePicker.headerTitle = customVariablesAndMethod1.currentDate(dateFormat: CustomDatePicker.ShowFormat)
        to_DatePicker.headerTitle = customVariablesAndMethod1.currentDate(dateFormat: CustomDatePicker.ShowFormat)
    ...
    @objc func OnGoBtnClicked(){
        ...
        if(T_date.compare(F_date) != .orderedAscending ){
            update_page()
        }else{
      ...
      func update_page() { 
        ...
        params["sFdate"] = from_DatePicker.getDate(dateFormat: CustomDatePicker.CommitFormat)
        params["sTdate"] = to_DatePicker.getDate(dateFormat: CustomDatePicker.CommitFormat)

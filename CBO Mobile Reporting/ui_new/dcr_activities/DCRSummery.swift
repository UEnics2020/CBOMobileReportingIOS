...
class DCRSummery: CustomUIViewController {
    ...
    @IBOutlet weak var bottomButtton: CustomeUIButton!
    var context : CustomUIViewController!
    var Back_allowed = "Y",AllowFinalSubmit = "N"
    ...
    override func viewDidLoad() {
        ...
        if  VCIntent["title"] != nil{
         ...
         if  VCIntent["AllowFinalSubmit"] != nil{
            
            AllowFinalSubmit = VCIntent["AllowFinalSubmit"]!
        }
        
        if VCIntent["Back_allowed"] == "N" {
            bottomButtton.setText(text: "OK")
        }
...
//        print(doctor_list)
        ...
        do {
            ...
            if( customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "Rx_NA_NOT_REQUIRED", defaultValue: "Y") == "N"){
                summary_list.append([try cbohelp.getMenuNew(menu: "DCR", code: "D_RX_GEN_NA").getString(key: "D_RX_GEN_NA") :    tenivia_traker])
            }
            
            if( customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "Rx_NOT_REQUIRED", defaultValue: "Y") == "N"){
                summary_list.append([try cbohelp.getMenuNew(menu: "DCR", code: "D_RX_GEN").getString(key: "D_RX_GEN") :    tenivia_traker])
            }
        ...
        bottomButtton.addTarget(self, action: #selector(pressedbottomButton), for: .touchUpInside )
    }

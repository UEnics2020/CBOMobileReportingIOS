...
class DairyCall: CustomUIViewController , CustomTextViewWithButtonDelegate {
    ...
    let CALL_DILOG = 5 , REMARK_DILOG = 6 , WORK_WITH_DILOG=7 , PRODUCT_DILOG = 8
        ,INTERSTED_DILOG = 9,MESSAGE_INTERNET_DRCHEMDELETE_MOBILE = 10
    ...
    @IBOutlet weak var productLayout: UIStackView!
    ...
    // customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "live_km",defaultValue: "");
        ...
        intersed_list.append("Interested")
        intersed_list.append("Not Interested")
...
//            }
        ...
        case MESSAGE_INTERNET_DRCHEMDELETE_MOBILE:
            progressHUD.dismiss()
            self.cbohelp.delete_phdairy_dcr(DAIRY_ID: self.selected_dr_id)
            self.closeVC()
        ...
        if (chm_name == "") {
            ...
            Chm_sample_Dialog(vc: self, dr_List: docList,  responseCode: PRODUCT_DILOG, sample_name: sample_name, sample_pob: sample_pob, sample_sample: sample_sample).show()
        }
    }
            ...
            .DecisionAlert(vc: self,
                           ...
                           listener: { () -> OnClickListener in
                            class anonymous  : OnClickListener {
                                ...
                                init(parent : DairyCall,id: String,Dr_name : String) {
                                    self.parent = parent
                                    self.id = id

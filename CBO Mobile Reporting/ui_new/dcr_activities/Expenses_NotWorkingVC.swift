...
class Expenses_NotWorkingVC: CustomUIViewController,AddExpensesAdaperDalegate, ImagePickerDelegate , FTPUploadDelegate,CustomTextViewDelegate{
    
    func onTextChangeListner(sender: CustomTextView, text: String) {
        if (ACTUALFARE_MAXAMT>0){
            
            if ( (distAmt.getText().isEmpty ? 0 : Double( distAmt.getText())!) > ACTUALFARE_MAXAMT){
                AppAlert.getInstance().Alert(vc: context, title: "Alert!!!",
                                             massege: "Your AcutaFare cannot exceed \u{20B9} \(ACTUALFARE_MAXAMT)"){
                                                self.distAmt.setText(text: "\(self.ACTUALFARE_MAXAMT)");
                }
            }
        }
    }
    ...
    @IBOutlet weak var TAotherLayout: UIView!
    ...
    @IBOutlet weak var other_exp_layout: UIStackView!
    @IBOutlet weak var ta_layout: UIStackView!
    @IBOutlet weak var pressedOtherExpenses : CustomeUIButton!
    
    @IBOutlet weak var pressedMannualTAbtn : CustomeUIButton!
    @IBOutlet weak var ta_mannual_layout: UIStackView!
    ...
    MESSAGE_INTERNET_DCR_COMMITEXP=3,MESSAGE_INTERNET_DCR_DELETEEXP=4,MESSAGE_INTERNET_DCR_COMMITDCR=6,GPS_TIMMER=7,TA_MANUAL_UPDATE=8;
    ...
    override func viewDidLoad() {
        ...
        pressedMannualTAbtn.addTarget(self, action: #selector(mannualTA) , for: .touchUpInside)
    ...
    @objc func mannualTA(){
        ...
        let objAddAnotherExpenses = self.storyboard?.instantiateViewController(withIdentifier: "TAmannualExpense") as! TAmannualExpense
         objAddAnotherExpenses.vc =  self
        objAddAnotherExpenses.responseCode = TA_MANUAL_UPDATE
    ...
    override func getDataFromApi(response_code: Int, dataFromAPI: [String : NSArray]){
        ...
        case TA_MANUAL_UPDATE:
            if (customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context, key: "EXPTA_MGRMANUALYN", defaultValue: "Y") == "Y" && customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "DA_TYPE",defaultValue: "") != "L"){
                 distAmt.setText(text: customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "ACTUALFARE",defaultValue: "0"));
        ...
        if(!dataFromAPI.isEmpty){
            do {
                ...
                for i in 0 ..< jsonArray1.count {
                    ...
                    try Exp_head_list.append( DPItem(title: jsonObject1.getString(key: "FIELD_NAME") , code: jsonObject1.getString(key: "ID") ,type : jsonObject1.getString(key: "DA_ACTION") ));
                    try cbohelp.Insert_EXP_Head(FIELD_NAME: jsonObject1.getString(key: "FIELD_NAME") , FIELD_ID: jsonObject1.getString(key: "ID") ,MANDATORY: jsonObject1.getString(key: "MANDATORY") ,DA_ACTION: jsonObject1.getString(key: "DA_ACTION") , EXP_TYPE: jsonObject1.getString(key: "EXP_TYPE"), ATTACHYN: jsonObject1.getString(key: "ATTACHYN"), MAX_AMT: jsonObject1.getString(key: "MAX_AMT"), TAMST_VALIDATEYN: jsonObject1.getString(key: "TAMST_VALIDATEYN"));
                }
                ...
                for i in 0 ..< jsonArray3.count {
                    ...
                    try rootdata.append((object.getString(key: "DA_TYPE") ));
                    try rootdata.append((object.getString(key: "FARE")));
                    try rootdata.append((object.getString(key: "ACTUALFAREYN")));
                    try ROUTE_CLASS = (object.getString(key: "ROUTE_CLASS"))
                    try ACTUALDA_FAREYN = (object.getString(key: "ACTUALDA_FAREYN") )
                    
                    ACTUALFAREYN_MANDATORY  = try object.getString(key: "ACTUALFAREYN_MANDATORY")
                    ACTUALFARE_MAXAMT  = Double( try object.getString(key: "ACTUALFARE_MAXAMT") )!
                    
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE(vc: context,key: "ACTUALFAREYN",value: (try object.getString(key: "ACTUALFAREYN") ));
                    
                    
                    var MyDaType = try object.getString(key: "DA_TYPE_NEW");
                    var da_val = try object.getString(key: "DA_RATE_NEW");
                    ...
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE(vc: context,key: "distance_val",value: (try object.getString(key: "TA_AMT_NEW") ));
                    
                    customVariablesAndMethod.setDataInTo_FMCG_PREFRENCE(vc: context,key: "PER_KM",value: (try object.getString(key: "FARE_RATE_NEW") ));
                ...
                if (customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context, key: "EXPTA_MGRMANUALYN", defaultValue: "Y") == "Y" && customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "DA_TYPE",defaultValue: "") != "L"){
                    ...
                    distAmt.setText(text: customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "ACTUALFARE",defaultValue: ""));
                        ta_mannual_layout.isHidden = false
                        rootDistance.isHidden = true
                }
        ...
        if(!dataFromAPI.isEmpty){
            do {
                ...
                for i in 0 ..< jsonArray1.count {
                    ...
                    try Exp_head_list.append( DPItem(title: jsonObject1.getString(key: "FIELD_NAME") , code: jsonObject1.getString(key: "ID")));
                    try cbohelp.Insert_EXP_Head(FIELD_NAME: jsonObject1.getString(key: "FIELD_NAME") , FIELD_ID: jsonObject1.getString(key: "ID"),MANDATORY: jsonObject1.getString(key: "MANDATORY"),DA_ACTION: jsonObject1.getString(key: "DA_ACTION"), EXP_TYPE: jsonObject1.getString(key: "EXP_TYPE"), ATTACHYN: jsonObject1.getString(key: "ATTACHYN"), MAX_AMT: jsonObject1.getString(key: "MAX_AMT"), TAMST_VALIDATEYN: jsonObject1.getString(key: "TAMST_VALIDATEYN"));
                }
                if (Exp_head_list.count == 0) {
                    customVariablesAndMethod.msgBox(vc: context,msg: "No ExpHead found...");
                ...
                for i in 0 ..< jsonArray2.count {
                    ...
                    DistRate = try jsonObject1.getString(key: "FARE_RATE");
                    datype_local = try jsonObject1.getString(key: "DA_L");
                    datype_ex = try jsonObject1.getString(key: "DA_EX");
                    datype_ns = try jsonObject1.getString(key: "DA_NS");
                }
                ...
                for i in 0 ..< jsonArray3.count {
                    ...
                    try Area_dis_list.append( DPItem(title: jsonObject2.getString(key: "STATION_NAME")  , code: jsonObject2.getString(key: "DISTANCE_ID")));
                }
                ...
                for i in 0 ..< jsonArray4.count {
                    ...
                    try Area_da_list.append( DPItem(title: jsonObject2.getString(key: "PA_NAME") , code: ""));
                }
    ...
    @objc func SubmitExp(){
        ...
        if (final_submit_remark_layout.isHidden == false && final_remark.getText() == "") {
            ...
            if (route_distance_view.isHidden == false && distAmt.getText() == "" && ACTUALFAREYN_MANDATORY.uppercased() != ("N")) {
                ...
                if (distAmt.isHidden == true && !(customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context, key: "EXPTA_MGRMANUALYN", defaultValue: "Y") == "Y" && customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "DA_TYPE",defaultValue: "") != "L")){
        ...
        for x1 in exp_data{
            for x in x1 {
                ...
                if x.key == "Total Expenses" {
                    ...
                    //myLabel.font = myLabel.font.withSize(20)
                }
    ...
    func init_TAother_type(){
        
        RemoveAllviewsinProduct(myStackView: TAotherLayout)
        var i = 0
        var heightConstraint : NSLayoutConstraint!
        // var stackViewHeightConstraint : NSLayoutConstraint!
        var widthConstraint : NSLayoutConstraint!
       ...
       // exp_data.append(["+ TA." : ""])
        ...
        if(customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context, key: "EXPTA_MGRMANUALYN", defaultValue: "Y") == "Y" && customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context,key: "DA_TYPE",defaultValue: "") != "L"){
            ...
            Dis_val = Double(ACTUALFARE)!
                       
                       exp_data.append(["TA. Value" : "₹\( Dis_val)"])
        }else if (customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(vc: context, key: "ACTUALFAREYN",defaultValue: "").uppercased() != ("Y")  ) {
        ...
        for x1 in exp_data{
            for x in x1 {
                ...
                myLabel.translatesAutoresizingMaskIntoConstraints = false
                TAotherLayout.addSubview(myLabel)
                myLabel.text = x.key
                myLabel.textColor = .black //AppColorClass.colorPrimaryDark
                ...
                let myLabel2 = UILabel()
                TAotherLayout.addSubview(myLabel2)
                myLabel2.translatesAutoresizingMaskIntoConstraints = false
                myLabel2.numberOfLines = 0
                myLabel2.textColor = AppColorClass.colorPrimaryDark
                myLabel2.textAlignment = .right
                ...
                let myinnerStackView = UIStackView()
                myinnerStackView.axis =  .horizontal
                TAotherLayout.addSubview(myinnerStackView)
                myinnerStackView.translatesAutoresizingMaskIntoConstraints =  false
                ...
                if i == 0{
                    myinnerStackView.topAnchor.constraint(equalTo: TAotherLayout.topAnchor).isActive = true
                    myinnerStackView.leftAnchor.constraint(equalTo: TAotherLayout.leftAnchor).isActive = true
                    myinnerStackView .rightAnchor.constraint(equalTo: TAotherLayout.rightAnchor).isActive =  true
                    i = 1
                }else{
                    myinnerStackView.topAnchor.constraint(equalTo: previousStackView.bottomAnchor).isActive = true
                    myinnerStackView.leftAnchor.constraint(equalTo: TAotherLayout.leftAnchor).isActive = true
        ...
        //            let a = UIView()
        //            TAotherLayout.addSubview(a)
        //            a.topAnchor.constraint(equalTo: previousStackView.bottomAnchor).isActive =  true
        //            a.rightAnchor.constraint(equalTo: TAotherLayout.rightAnchor ).isActive =  true
        //            a.leftAnchor.constraint(equalTo: TAotherLayout.leftAnchor).isActive =  true
        //
        //            heightConstraint = NSLayoutConstraint(item: a, attribute: NSLayoutAttribute.height, relatedBy: NSLayoutRelation.equal, toItem: nil, attribute: NSLayoutAttribute.notAnAttribute, multiplier: 1, constant: 2)
        //            heightConstraint.priority = UILayoutPriority(rawValue: UILayoutPriority.RawValue(CGFloat(250)))
        //            heightConstraint.isActive =  true
        ...
        //previousStackView = a
        previousStackView.bottomAnchor.constraint(equalTo: TAotherLayout.bottomAnchor).isActive =  true

...
//        AttachmentImageView.image = objImagePicker.getPhotoFromCustomAlbum()
   ...
   //    AttachmentImageView.image = UIImage(contentsOfFile: objImagePicker.getImageFromApplicationFolder(FOLDER_NAME: objImagePicker.albumName, filename: "4282_23__1526365193.40796.jpg"))
        ...
        amt_txt.onTextChanged = { text in
            ...
            var text = text.replacingOccurrences(of: "Enter Text", with: "").replacingOccurrences(of: "Amt", with: "").replacingOccurrences(of: ".", with: "")
            ...
            do {
                ...
                if regex.firstMatch(in: text, options: [], range: NSMakeRange(0, text.characters.count)) != nil {
                    ...
                    self.amt_txt.setText(text: text.substring(to: text.index(before: text.endIndex)))

                } else {

                       
                        self.amt_txt.setText(text: text)
